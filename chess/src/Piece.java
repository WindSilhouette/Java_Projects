...
public class Piece {
    ...
    public boolean isMoveLegal(Board board, int endRow, int endCol) {
        switch (this.character) {
            ...
            case '\u2659':
                if(endRow == 0){
                    promotion(board, endRow,endCol, false);
                }
            case '\u265f':
                if(endRow == 7){
                    promotion(board, endRow,endCol, true);
                }
    ...
    public void promotion(Board board,int endRow, int endCol, Boolean isBlack){
        System.out.println("What piece do you want back input format:(Queen, Rook, Bishop, Knight");
